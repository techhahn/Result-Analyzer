...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
        	<div class="row">
        		<div class="col-xs-1 col-sm-6 col-md-12 col-lg-12">
        ...
        <script>window.jQuery || document.write('<script src="packages/jquery/jquery.js"><\/script>')</script>

        <!-- <script type="text/javascript" src="packages/angular/angular.min.js"></script>
        <script type="text/javascript" src="packages/angular/angular-route.min.js"></script> -->
